...
function GameManager(in_canvas, in_subcanvas) {
	this.canvas = in_canvas;
	this.subcanvas = in_subcanvas;
...
GameManager.prototype.disp = function() {
	...
	if (this.canvas != null) {
		if (this.canvas.getContext) {
			...
			var context = this.canvas.getContext("2d");
			var subcontext = this.subcanvas.getContext("2d");
			...
			subcontext.clearRect(0, 0, this.subcanvas.width, this.subcanvas.height);
			...
			if (this.nowScene.subdisp) this.nowScene.subdisp(subcontext);
